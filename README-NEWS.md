...
6. Use one of these types: `lecture`, `visit`, `talk`, `reception`, `award`, or `other`. Keep summaries to one or two sentences. Set `featured` to `true` for homepage eligibility.
